    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(UserModel userModel)
        {
            ...
            try
            {
                ...
                int Id = 1;
                userModel.DepartmentId = (1).ToString();
                ...
                try
                {
                    p = context.GetPeoplebyCompanyId(Id).Where(a => a.Email.Equals(userModel.Email)).SingleOrDefault();
                }
                catch (Exception ex) { }
                if (p == null)
                {
                    ...
                    p.Permissions = userModel.Permissions;
