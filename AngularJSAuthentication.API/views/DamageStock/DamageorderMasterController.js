'use strict';
app.controller('DamageorderMasterController', ['$scope', 'DamageOrderMasterService', 'DamageOrderDetailsService', '$http', 'ngAuthSettings', '$filter', "ngTableParams", '$modal',
    function ($scope, DamageOrderMasterService, DamageOrderDetailsService, $http, ngAuthSettings, $filter, ngTableParams, $modal) {
        ...
        $scope.getData = function (pageno) { // This would fetch the data on page change.
            ...
            $scope.customers = [];
            var url = serviceBase + "api/DamageOrderMaster" + "?list=" + $scope.itemsPerPage + "&page=" + pageno;
