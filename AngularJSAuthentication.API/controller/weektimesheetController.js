'use strict';
app.controller('weektimesheetController', ['$scope', 'tasktypesService', '$http', 'ngAuthSettings','ClientProjectService','logger', function ($scope, tasktypesService, $http, ngAuthSettings, ClientProjectService,logger) {
