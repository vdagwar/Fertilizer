'use strict';
app.controller('userdashboardController', ['$scope', '$http', "$filter", 'ngAuthSettings', '$routeParams','$location', function ($scope, $http, $filter, ngAuthSettings, $routeParams,$location) {
