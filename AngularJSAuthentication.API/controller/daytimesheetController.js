'use strict';
app.controller('daytimesheetController', ['$scope', 'tasktypesService', '$http', 'ngAuthSettings', 'ClientProjectService', function ($scope, tasktypesService, $http, ngAuthSettings, ClientProjectService) {
